...
class TestLogManager:
    ...
    def test_read_log_file_success(self, mock_file, log_manager):
    ...
    def test_read_log_file_error(self, mock_file, log_manager):
        log_file = Path("/tmp/test_outputs/run_1/.hydra/hydra.log")
    ...
    def test_get_log(self, log_manager, mock_log_registry, sample_log):
    ...
    def test_get_log_not_found(self, log_manager, mock_log_registry):
    ...
    def test_get_logs_by_client_run(self, log_manager, mock_log_registry, sample_log):
